class Card {
  ...
  onMouseOver (c) {
    c.addEventListener('mousemove', function (e) {
      ...
      let matrix3Dx = ((mouseX/10000)*1.9)-0.0001
      let matrix3Dy = ((mouseY/10000)*2.05)-0.0001

      c.style.transform = "translate3d(0,0,0) matrix3d(1,0,0.00,"+matrix3Dx+",0.00,1,0.00,"+matrix3Dy+",0,0,1,0,0,0,0,1) scale(1.04)"
    })
  }
